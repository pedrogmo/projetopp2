...
namespace apBioPlay.DAO
{
    public class SiteContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=regulus.cotuca.unicamp.br;Initial Catalog=PR118174;User ID=PR118174;Password=PR118174; Min Pool Size=5;Max Pool Size=250; Connect Timeout=5");
        }
    }
}