...
insert into Paragrafo values('Hoje em dia é comum ouvirmos que algumas regiões brasileiras estão sofrendo com a falta de água, porém, não entendemos como nossas atitudes estão diretamente relacionadas com essa triste situação. O uso inadequado, a poluição e contaminação desse importante recurso natural poderão causar, em breve, graves problemas de abastecimento.', 6)
...
insert into Paragrafo values('A seguir listaremos algumas dicas importantes para que você comece a poupar água hoje mesmo:', 6)
insert into Paragrafo values('* A primeira dica e uma das mais importantes: Tome banhos rápidos. Alguns autores afirmam que, se você se ensaboar com o chuveiro desligado, é possível economizar cerca de 130 litros de água. Além de economizar água, economiza-se também energia elétrica;', 6)
insert into Paragrafo values('* Lembre-se sempre de fechar a torneira enquanto escova os dentes ou faz a barba;', 6)
insert into Paragrafo values('* Não limpe a calçada com água. Caso seja necessário, utilize baldes e opte por água que já foi utilizada, como a água da máquina de lavar;', 6)
insert into Paragrafo values('* Cuidado com as torneiras que ficam pingando. Estudos indicam que um pequeno pinga-pinga provoca a perda de cerca de 16 mil litros de água por ano;', 6)
insert into Paragrafo values('* Atenção aos vazamentos! Essa atitude, além de economizar água, evita danos ao imóvel;', 6)
insert into Paragrafo values('* Fique atento à descarga e se esta não está desregulada. É importante também evitar apertar o botão por um longo período de tempo;', 6)
insert into Paragrafo values('* Ao encher a caixa da água, tome cuidado para que ela não transborde;', 6)
insert into Paragrafo values('* Se você possui piscina em casa, lembre-se sempre de manter uma cobertura sobre ela para evitar a perda de água por evaporação;', 6)
insert into Paragrafo values('* Ao lavar a louça, primeiro procure retirar o excesso de sujeira e somente depois ligue a torneira. Enquanto estiver ensaboando a louça, evite ficar com a torneira ligada;', 6)
insert into Paragrafo values('* Evite lavar uma peça de roupas por vez. O ideal é juntar várias peças para que a máquina seja usada sem desperdício;', 6)
insert into Paragrafo values('* Utilize água das chuvas para molhar as plantas e escolha sempre o horário da manhã ou noite, pois nesses horários a água não evapora rapidamente;', 6)
insert into Paragrafo values('* Lave o carro apenas uma vez por mês e use sempre um balde com água. O uso de mangueiras pode provocar um desperdício de mais de 500 litros de água a cada meia hora.', 6)
insert into Paragrafo values('Lembre-se de que, apesar dos dias secos e da falta de chuva, você também exerce influência na disponibilidade de água. Atitudes conscientes são fundamentais para garantir que água de qualidade continue disponível!', 6)
insert into Paragrafo values('Não desperdice!', 6)
insert into Paragrafo values('Por Ma. Vanessa dos Santos', 6)
insert into Paragrafo values('Fonte: Brasil Escola', 6)
